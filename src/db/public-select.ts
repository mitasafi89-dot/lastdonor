...
import { campaigns, donations, campaignMessages, campaignMilestones } from '@/db/schema';
...
/** Public milestone fields — phase, status, title, description, and fund info for transparency. */
export const publicMilestoneSelect = {
